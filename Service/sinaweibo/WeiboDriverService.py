...
from DAO.sinaweibo.WeiboDao import WeiboDao
from datetime import datetime
from Service.sinaweibo.WeiboAPIService import WeiboAPIService
import re
import time
...
class WeiboDriverService(object):
    ...
    def setScreen_Name(self,screen_name):
        self.userInfo = self.weiboAPIService.getUserInfo(screen_name)
